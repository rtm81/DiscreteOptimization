...
public class CrossoverTest {
	...
	public void testSubTour() throws Exception {
		...
		List<Point> pointList = new ProblemDataParser()
				.parse(problemDataString);
		...
		Map<Integer, Integer> solutionList1 = tourConfigurationParser
				.parseTourSolution(solutionString1);
		...
		Map<Integer, Integer> solutionList2 = tourConfigurationParser
				.parseTourSolution(solutionString2);
